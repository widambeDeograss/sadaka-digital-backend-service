# Generated by Django 5.0.6 on 2025-03-09 05:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(default=11111111, max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_by', models.CharField(max_length=255)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('permissions', models.ManyToManyField(related_name='role_permissions', to='user_management.systempermission')),
            ],
        ),
        migrations.AddField(
            model_name='user',
